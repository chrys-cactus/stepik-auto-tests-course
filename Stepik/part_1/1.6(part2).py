...
try:
    ...
    input1 = browser.find_element_by_css_selector("input.form-control[name='first_name']")
    input1.send_keys("Ivan")
    input2 = browser.find_element_by_css_selector("input.form-control[name='last_name']")
